...
static const struct parent_map mmcc_xo_mmpll0_dsi_gpll0_map[] = {
	{ P_XO, 0 },
	{ P_MMPLL0, 1 },
	{ P_GPLL0, 5 },
	{ P_DSI0PLL, 2 },
...
static const char * const mmcc_xo_mmpll0_dsi_gpll0[] = {
	"xo",
	"mmpll0_vote",
	"mmss_gpll0_vote",
	"dsi0pll",
...
static const struct parent_map mmcc_xo_mmpll0_1_gpll0_map[] = {
	{ P_XO, 0 },
	{ P_MMPLL0, 1 },
	{ P_MMPLL1, 2 },
	{ P_GPLL0, 5 },
...
static const char * const mmcc_xo_mmpll0_1_gpll0[] = {
	"xo",
	"mmpll0_vote",
	"mmpll1_vote",
	"mmss_gpll0_vote",
...
static const struct parent_map mmcc_xo_dsi_map[] = {
	{ P_XO, 0 },
	{ P_DSI0PLL, 1 },
};

static const char * const mmcc_xo_dsi[] = {
	"xo",
	"edp_link_clk",
	"dsi0pll",
};

static const struct parent_map mmcc_xo_dsi_gpll0_map[] = {
	{ P_XO, 0 },
	{ P_GPLL0, 5 },
	{ P_DSI0PLL, 1 },
};

static const char * const mmcc_xo_dsi_gpll0[] = {
	"xo",
	"edp_link_clk",
	"gpll0_vote",
	"dsi0pll",
...
static const struct parent_map mmcc_xo_dsibyte_gpll0_map[] = {
	{ P_XO, 0 },
	{ P_GPLL0, 5 },
	{ P_DSI0PLL_BYTE, 1 },
};

static const char * const mmcc_xo_dsibyte_gpll0[] = {
	"xo",
	"edp_link_clk",
	"gpll0_vote",
	"dsi0pllbyte",
...
static struct clk_pll mmpll0 = {
	.l_reg = 0x0004,//MMPLL0_L_VAL
	.m_reg = 0x0008,//MMPLL0_M_VAL 
	.n_reg = 0x000c,//MMPLL0_N_VAL 
	.config_reg = 0x0014,
	.mode_reg = 0x0000,//MMPLL0_PLL_MODE 
	.status_reg = 0x001c,//MMPLL0_PLL_STATUS                                  (0x001C)
	.status_bit = 17,
...
static struct clk_regmap mmpll0_vote = {
	.enable_reg = 0x0100,//MMSS_PLL_VOTE_APCS                                 (0x0100)
	.enable_mask = BIT(0),
...
static struct clk_pll mmpll1 = {
	.l_reg = 0x0044,//MMPLL1_PLL_L_VAL                                   (0x0044)
	.m_reg = 0x0048,// MMPLL1_PLL_M_VAL                                   (0x0048)
	.n_reg = 0x004c,//MMPLL1_PLL_N_VAL                                   (0x004C)
	.config_reg = 0x0050,//MMPLL1_PLL_USER_CTL                                (0x0050)
	.mode_reg = 0x0040,//MMPLL1_PLL_MODE                                    (0x0040)
	.status_reg = 0x005c,//MMPLL1_PLL_STATUS                                  (0x005C)
	.status_bit = 17,
        .clkr.hw.init = &(struct clk_init_data){
                .name = "mmpll1",
                .parent_names = (const char *[]){ "xo" },
...
static struct freq_tbl ftbl_camss_vfe_vfe0_clk[] = {
	F(37500000, P_GPLL0, 16, 0, 0),
	F(50000000, P_GPLL0, 12, 0, 0),
...
static struct freq_tbl ftbl_mdss_mdp_clk[] = {//ok
	F(37500000, P_GPLL0, 16, 0, 0),
	F(60000000, P_GPLL0, 10, 0, 0),
	F(75000000, P_GPLL0, 8, 0, 0),
...
static struct clk_rcg2 mdp_clk_src = {
	.cmd_rcgr = 0x2040,
	.hid_width = 5,
	.parent_map = mmcc_xo_mmpll0_dsi_gpll0_map,
	.freq_tbl = ftbl_mdss_mdp_clk,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "mdp_clk_src",
		.parent_names = mmcc_xo_mmpll0_dsi_gpll0,
		.num_parents = 6,
		.ops = &clk_rcg2_ops,
	},
};

static struct freq_tbl ftbl_camss_jpeg_jpeg0_clk[] = {
	F(75000000, P_GPLL0, 8, 0, 0),
	F(133330000, P_GPLL0, 4.5, 0, 0),
	F(200000000, P_GPLL0, 3, 0, 0),
	F(228570000, P_MMPLL0, 3.5, 0, 0),
...
static struct clk_rcg2 pclk0_clk_src = {
	.cmd_rcgr = 0x2000,// PCLK0_CMD_RCGR   
	.mnd_width = 8,
	.hid_width = 5,
	.parent_map = mmcc_xo_dsi_gpll0_map,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "pclk0_clk_src",
		.parent_names = mmcc_xo_dsi_gpll0,
		.num_parents = 6,
		.ops = &clk_pixel_ops,
...
static struct clk_rcg2 vcodec0_clk_src = {
	...
	.mnd_width = 8,
	.hid_width = 5,
	.parent_map = mmcc_xo_mmpll0_1_gpll0_map,
	.freq_tbl = ftbl_venus0_vcodec0_clk,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "vcodec0_clk_src",
		.parent_names = mmcc_xo_mmpll0_1_gpll0,
		.num_parents = 5,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct freq_tbl ftbl_camss_phy0_1_csi0_1phytimer_clk[] = {
	F(100000000, P_GPLL0, 6, 0, 0),
	F(200000000, P_MMPLL0, 4, 0, 0),
	{ }
};
...
static struct clk_rcg2 byte0_clk_src = {
	.cmd_rcgr = 0x2120,
	.hid_width = 5,
	.parent_map = mmcc_xo_dsibyte_gpll0_map,
	.freq_tbl = byte_freq_tbl,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "byte0_clk_src",
		.parent_names = mmcc_xo_dsibyte_gpll0,
		.num_parents = 6,
		.ops = &clk_byte2_ops,
		.flags = CLK_SET_RATE_PARENT,
	},
...
static struct freq_tbl ftbl_mdss_esc0_clk[] = {
	F(19200000, P_XO, 1, 0, 0),
	{ }
};
...
static struct clk_regmap *mmcc_msm8226_clocks[] = {
	...
	//[CAMSS_CSI2_AHB_CLK] = &camss_csi2_ahb_clk.clkr,not sure
